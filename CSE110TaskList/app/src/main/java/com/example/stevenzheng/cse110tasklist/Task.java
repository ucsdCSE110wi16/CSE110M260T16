...
public class Task {
    ...
    public Task () {}
    public Task (String name, String desc, int difc, String taskGroup, boolean rep, int day, int month, int year, String personAssigned, String group) {
        this.name = name;
        this.desc = desc;
        this.difc = difc;
        this.rep = rep;
    ...
    public ParseObject getParseTask() {
        ...
        parseTask.put("taskGroup", taskGroup);
